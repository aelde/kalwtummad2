...
const char* mqtt_Client = "3541f2c7-92d0-4a12-a00c-15e55a129dc6";
const char* mqtt_username = "rT42RuqubtDxCowpUWGKoenTTBueTevG";
const char* mqtt_password = "$BjXN63xXWUlJXfFH3gRyhWal~DaZK26";
